                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{asset('storage/image/'.$product->image)}}"><img class="product__media--preview__items--img" src="{{asset('storage/image/'.$product->image)}}"></a>
                                        <div class="product__media--view__icon">
                                            <a class="product__media--view__icon--link glightbox" href="{{asset('storage/image/'.$product->image)}}" data-gallery="product-media-preview">
                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="{{asset('storage/image/'.$product->image)}}"><img class="product__media--preview__items--img" src="{{asset('storage/image/'.$product->image)}}" alt="product-media-img"></a>
                                        <div class="product__media--view__icon">
                                            <a class="product__media--view__icon--link glightbox" href="{{asset('storage/image/'.$product->image)}}" data-gallery="product-media-preview">
                                                <svg class="product__media--view__icon--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512">
                                                    <path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path>
                ...
                <div class="col">
                    <div class="product__details--info">
                        <form action="{{url('add_to_cart', $product->id)}}" method="post">
                            @csrf
                            <img src="{{asset('storage/image/'.$product->image)}}" style="display: none;" alt="">
                            ...
                            <div class="product__variant">
                                <div class="product__variant--list quantity d-flex align-items-center mb-20">
                                    <div class="quantity__box">
                                        ...
                                        <label>
                                            <input type="number" class="quantity__number quickview__value--number" name="quantity" value="1" min="1" data-counter />
                                        </label>
                            ...
                            <div class="guarantee__safe--checkout">
                                ...
                                <img class="guarantee__safe--checkout__img" src="img/other/safe-checkout.png" alt="Payment Image">
                            </div>
                        </form>
                    </div>
                </div>
                                    ...
                                    <div class="reviews__comment--area">
                                        <div class="reviews__comment--list d-flex">
                                            <div class="reviews__comment--thumb">
                                                <img src="img/other/comment-thumb1.png" alt="comment-thumb">
                                            </div>
                                        ...
                                        <div class="reviews__comment--list margin__left d-flex">
                                            <div class="reviews__comment--thumb">
                                                <img src="img/other/comment-thumb2.png" alt="comment-thumb">
                                            </div>
                                            <div class="reviews__comment--content">
                                                <div class="reviews__comment--top d-flex justify-content-between">
                                                    <div class="reviews__comment--top__left">
                                        ...
                                        <div class="reviews__comment--list d-flex">
                                            <div class="reviews__comment--thumb">
                                                <img src="img/other/comment-thumb3.png" alt="comment-thumb">
                                            </div>
                                            <div class="reviews__comment--content">
                                                <div class="reviews__comment--top d-flex justify-content-between">
                                                    <div class="reviews__comment--top__left">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="quickview__thumb">
                                    <a class="quickview__thumb--link" href="product-details.html"><img class="quickview__thumb--img" src="img/product/big-product2.jpg" alt="product-img"></a>
                                    <div class="product__badge">
                                        <span class="product__badge--items sale">Sale</span>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="quickview__thumb">
                                    <a class="quickview__thumb--link" href="product-details.html"><img class="quickview__thumb--img" src="img/product/big-product3.jpg" alt="product-img"></a>
                                    <div class="product__badge">
                                        <span class="product__badge--items sale">Sale</span>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="quickview__thumb">
                                    <a class="quickview__thumb--link" href="product-details.html"><img class="quickview__thumb--img" src="img/product/big-product4.jpg" alt="product-img"></a>
                                    <div class="product__badge">
                                        <span class="product__badge--items sale">Sale</span>
                                    </div>
                                </div>
                            ...
                            <div class="product__variant">
                                <div class="product__variant--list mb-15">
                                    <fieldset class="variant__input--fieldset">
                                        ...
                                        <label class="variant__color--value red" for="color-red5" title="Red"><img class="variant__color--value__img" src="img/product/product1.png" alt="variant-color-img"></label>
                                        <input id="color-red6" name="color" type="radio">
                                        <label class="variant__color--value red" for="color-red6" title="Black"><img class="variant__color--value__img" src="img/product/product2.png" alt="variant-color-img"></label>
                                        <input id="color-red7" name="color" type="radio">
                                        <label class="variant__color--value red" for="color-red7" title="Pink"><img class="variant__color--value__img" src="img/product/product3.png" alt="variant-color-img"></label>
                                        <input id="color-red8" name="color" type="radio">
                                        <label class="variant__color--value red" for="color-red8" title="Orange"><img class="variant__color--value__img" src="img/product/product4.png" alt="variant-color-img"></label>
                                    </fieldset>
                                </div>
                                <div class="product__variant--list mb-15">
