                    ...
                    <div class="col-lg-8">
                        <div class="cart__table">
                                    ...
                                    <tr class="cart__table--body__items">
                                        ...
                                        <td class="cart__table--body__list">
                                            <div class="quantity__box">
                                                ...
                                                <label>
                                                    <input type="number" class="quantity__number quickview__value--number" value="{{$cart->quantity}}" data-counter />
                                                </label>
                            ...
                            <div class="continue__shopping d-flex justify-content-between">
                                ...
                                <button class="continue__shopping--clear">Clear Cart</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
